...
<body>
	<?php 
		...
		$sql_insert = "INSERT INTO employees_table( employee_name, employee_mail_id, employee_dob, employee_designation, employee_img, employee_password) VALUES ('$employeeName','$employeeId','$employeeDob','$employeeDesignation','$employeePicture','$employeePassword1')";   
		...
		//INSERT INTO `employees_profile`( `employee_name`, `employee_mail_id`, `employee_dob`, `employee_designation`, `employee_img`, `employee_password`) VALUES ('test','test@test.com','02-02-1292','devloper','Avatar.img','qwert1234')
			...
			$sql = "SELECT sl_no, employee_name, employee_mail_id, employee_dob, employee_designation, employee_img, employee_password FROM employees_table WHERE employee_mail_id = '$employee_mail_id'";
